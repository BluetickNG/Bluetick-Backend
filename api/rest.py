...
#     # TODO: 
#     # send otp to user through email - almost done
#     # verify otp
#     # if otp is correct, create workspace
...
# toke = TOTPVerification.generate_token(self)
# print (toke)
...
# print(bytes(random_hex(20), 'utf-8'))